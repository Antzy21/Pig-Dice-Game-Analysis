...
\subsubsubsection{Basics of Pig}
...
\\
\\
The probabilities of winning the game from any gamestate can be simplified down into sets of linear equations.
...
from the current position and $Q_{ijk}$ denote probability of B winning from the equivalent position (where $i$ then represents B's
banked points etc.). Then, \begin{equation}\label{1.2.1.a}
